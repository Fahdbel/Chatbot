...
def ask_llm_with_data(question):
    ...
    if "2021" in question:
        filtered_data = df[["TYPE_INTERMEDIAIRE", "DIM_2021"]].head(400).to_dict()
    elif "2022" in question:
        filtered_data = df[["TYPE_INTERMEDIAIRE", "DIM_2022"]].head(400).to_dict()
    elif "2023" in question:
        filtered_data = df[["TYPE_INTERMEDIAIRE", "DIM_2023"]].head(400).to_dict()
    elif "2024" in question:
        filtered_data = df[["TYPE_INTERMEDIAIRE", "DIM_2024"]].head(400).to_dict()
    else:
        filtered_data = df[["TYPE_INTERMEDIAIRE", "DIM_2021", "DIM_2022", "DIM_2023", "DIM_2024"]].head(400).to_dict()
